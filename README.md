...
5. Pour tester sur l'emulateur IOS

   npm run build
   npm run preview -- --host
   
   copier cette url dans safari http://localhost:4173/
   cliquez sur les ... points ensuite share view more et pour finir cliquez sur add to Home Screen pour finaliser l'installation
