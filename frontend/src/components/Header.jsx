    ...
    <header className="header">
      ...
      <a href="/" className="header-logo" aria-label="Retourner à la page d'accueil de Montréal.ca">
        <svg viewBox="0 0 184.6 39.3" xmlns="http://www.w3.org/2000/svg" aria-labelledby="logo-vdm" role="img" className="header-logo-svg">
          ...
          <path className="letter" d="M39.3,31.6c3.7,0,4.1-4.6,4.1-7.9c0-3.3-0.4-7.9-4.1-7.9c-3.6,0-4.1,4.6-4.1,7.9C35.2,27.1,35.7,31.6,39.3,31.6 M30.7,23.8 c0-6.1,2.9-9.4,8.6-9.4s8.6,3.3,8.6,9.4s-2.9,9.4-8.6,9.4S30.7,29.9,30.7,23.8z" />
          <path className="letter" d="M51.1,14.7h4.1V19h0.1c0.7-1.3,2.5-4.7,6.8-4.7c3.4,0,4.9,2.7,4.9,5.3v13.2h-4.1V21.5c0-2.3-0.4-4.3-2.5-4.3c-4.1,0-5.2,5.9-5.2,8.2v7.5h-4.1L51.1,14.7" />
          <path className="letter" d="M82,32.9c-0.8,0.2-1.9,0.3-2.9,0.3c-3.9,0-6.1-1.1-6.1-4.6V16.7h-3.1v-2H73v-4.2l4.1-2.3v6.6h5.3v2h-5.3v10.4c0,2.7,0.3,3.9,2.9,3.9c0.7,0,1.4-0.1,1.9-0.3L82,32.9" />
          <path className="letter" d="M85.1,14.7h4.1v4.6h0.1c1.3-2.4,2.7-4.7,6.3-5v4c-4,0.1-6.4,1.4-6.4,6.2v8.3h-4.1V14.7" />
          <path className="letter" d="M105.8,6.6h4.3l-4,5H103L105.8,6.6 M108.8,20c0-1.4-0.5-4.1-3.6-4.1c-3.2,0-3.8,3-3.9,4.1H108.8z M112.5,32.2c-1.7,0.6-3.2,1-5.7,1c-5.4,0-9.7-3-9.7-10.2c0-5,2.2-8.6,8.3-8.6c6.3,0,7.5,3.9,7.5,7.4h-11.7c0,3.6,1.7,9.5,7.6,9.5c1.3,0,2.5-0.2,3.7-0.8V32.2z" />
          ...
          <rect className="letter" x="134.5" y="6.6" width="4.1" height="26.2" />
      ...
      <div className="header-compte">
        <button
          type="button"
          className="header-compte-btn"
          onClick={handleMonCompteClick}
          aria-label="Mon compte"
        >
          
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="header-compte-icon" aria-hidden="true">
        ...
        {messageVisible && (
          <div className="header-compte-message" role="alert">
            Cette fonctionnalité n'est pas encore disponible.
            <button
              className="header-compte-message-close"
